...
const StreamsFilters = ({ searchTerm, setSearchTerm, onApply, onReset }) => {
  ...
  useEffect(() => {
    ...
    getRequest(`classes?session=${currentSession?._id}&isPagination=false&isSenior=true`)
