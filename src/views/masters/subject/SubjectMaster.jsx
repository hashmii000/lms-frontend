          ...
          <table className="w-full text-sm">
            <thead className="bg-gray-200">
              <tr>
                ...
                <th className=" px-3 py-2 text-center text-sm font-semibold">Stream Name</th>
                <th className=" px-3 py-2 text-center text-sm font-semibold">Subject Name</th>
              ...
              {!appliedClassId ? (
                ...
                data.map((item, index) => (
                  <tr key={item._id} className="hover:bg-gray-50">
                    ...
                    <td className="border px-3 py-2">{item?.stream?.name || '-'}</td>
